...
class COVID19Algeria(COVID19HistoricalDataRetriever):
    """
    Data retriever that uses the data from:
    https://msprh-dz.maps.arcgis.com/apps/opsdashboard/index.html#/eb524fcb95374f2cb60352b426e6e340
    """

    def __init__(self):

        self.wilayat_url =   'https://services8.arcgis.com/yhz7DEAMzdabE4ro/arcgis/rest/services/Cas_confirme_wilaya/FeatureServer/0/query?f=json&where=1%3D1&returnGeometry=false&spatialRel=esriSpatialRelIntersects&outFields=*&orderByFields=Cas_confirm%20desc&outSR=102100&resultOffset=0&resultRecordCount=48&cacheHint=true'
...
parser.add_argument('--source', '-s', required=True, choices=[COVID19Maghreb.__name__, COVID19Algeria.__name__],
...
if __name__ == '__main__':
    ...
    elif args.source == COVID19Algeria.__name__:
        retriever = COVID19Algeria()
